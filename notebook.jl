...
# ╔═╡ b05b26c6-e580-11ef-1895-c57238c428b6
begin
	using DataFrames
	using CSV
end

# ╔═╡ fc216c44-2f57-4d7e-8e84-6547342f7dd0
using Plots 

# ╔═╡ 60a24b07-2afc-49f8-b21a-ff4de95777b8
using PlutoUI

# ╔═╡ da4a4bb1-87eb-4345-a789-43ddcc501ad7
df = CSV.read("/home/dannys/learn_julia/WHO-COVID-19-global-data.csv", DataFrame)

# ╔═╡ 76b3a224-8aba-4f66-95c2-4065c381ddef
df.Country_code === df[!, "Country_code"]

# ╔═╡ 03392648-44ce-4a43-b0bb-ae6ec7ebd01b
equals_sg(x::AbstractString) = x == "SG"

# ╔═╡ def5cbfe-97b2-4805-9567-c5c5c428347a
sg_data = filter(:Country_code => equals_sg, df)

# ╔═╡ 62d16bba-0c1d-428b-9f3e-7ebf276a9bf0
dates = sg_data[!, "Date_reported"]

# ╔═╡ c71081c4-b17d-4e82-a2c9-f0226e2427ba
cumulative_cases = sg_data[!, "Cumulative_cases"]

# ╔═╡ 555e7aff-6a6e-4a08-a1f6-53bcba4df028
cumulative_data_plotted_over_date = plot(dates, cumulative_cases)

# ╔═╡ 12c1f9ab-92f4-4129-8c7d-b335bcd7f87f
...
# ╔═╡ 7c3abcb9-8ce4-4906-a608-e46022892e9e
@bind slider_value Slider(0:10:1000)

# ╔═╡ a6b8bf90-808c-4908-90c7-334c3f35ffef
md"""
### Slider Value Now At $(slider_value)
"""

# ╔═╡ 31846829-1e81-4a3e-92d1-12d0ea26a42b
@bind date_slider_index Slider(1:length(dates))

# ╔═╡ f3240c0d-d36a-4e11-97f7-9e9ece27d3c4
md"""
### The date is now $(dates[date_slider_index])
"""

# ╔═╡ fcac4371-2ee5-451a-9271-33817bdfebab
